...
<style>
    ...
    .fm-footer .footer-links {
        list-style: none;
        padding: 0;
        margin: 0;
    }

    .fm-footer .footer-links li {
        margin-bottom: 10px;
    }
    ...
    .fm-footer .footer-links a:hover {
        color: #ecfdf5;
        gap: 12px;
    }

    .fm-footer .footer-links a i {
        font-size: 0.7rem;
        color: #10b981;
    }
    ...
    .fm-footer .footer-copyright {
        color: #6ee7b7;
        font-size: 0.82rem;
    }

    .fm-footer .footer-bottom-links {
        display: flex;
        gap: 20px;
    }
    ...
    .fm-footer .footer-bottom-links a:hover {
        color: #ecfdf5;
    }
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-2 col-md-6 col-6">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="#" data-auth-modal="signup"><i class="fas fa-chevron-right"></i> Register</a></li>
                    <li><a href="#" data-auth-modal="login"><i class="fas fa-chevron-right"></i> Login</a></li>
                </ul>
            </div>
