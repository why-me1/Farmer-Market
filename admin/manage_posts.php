...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .mini-stat-icon.amber  { background: #fef3c7; color: #d97706; }
        .mini-stat-icon.green  { background: #dcfce7; color: #16a34a; }

        .mini-stat-value { font-size: 1.45rem; font-weight: 700; color: #0f172a; line-height: 1; }
        .mini-stat-label { font-size: .74rem; color: #64748b; margin-top: 3px; }

        /* Table card */
        .table-card {
            background: #fff; border-radius: 16px;
            border: 1px solid #e2e8f0; overflow: hidden; margin-top: 24px;
        }
        ...
        .table-card-header h5 { font-size: .95rem; font-weight: 700; color: #0f172a; margin: 0; }
        ...
        .tab-pill.active-amber { background: #f59e0b; color: #fff; }
        ...
        .search-box input {
            ...
            font-family: 'Inter', sans-serif; width: 200px; outline: none;
        ...
        .posts-table thead th {
            background: #f8fafc; font-size: .72rem; font-weight: 600;
        ...
        .posts-table td {
            padding: 13px 16px; font-size: .84rem; color: #334155;
        ...
        .farmer-name { font-weight: 600; font-size: .84rem; color: #0f172a; }

        /* Product cell */
        .product-name { font-weight: 600; color: #0f172a; font-size: .85rem; }
        .product-qty  { font-size: .74rem; color: #94a3b8; margin-top: 2px; }

        /* Price */
        .price-cell { font-weight: 700; color: #059669; font-size: .88rem; }
        ...
        .btn-approve {
            ...
            border: none; cursor: pointer; text-decoration: none; transition: background .18s;
            white-space: nowrap;
        }

        .btn-approve:hover { background: #bbf7d0; color: #064e3b; }
        ...
        /* Modal */
        .modal-confirm .modal-header { background: #fee2e2; border-bottom: none; border-radius: 12px 12px 0 0; }
        .modal-confirm .modal-title  { font-weight: 700; color: #991b1b; font-size: .95rem; }
        .modal-confirm .modal-body   { font-size: .86rem; color: #334155; }
...
<script>
    ...
    if (params.get('approved') === '1') showToast('bi-check-circle-fill', 'Post approved successfully.', 'success');
