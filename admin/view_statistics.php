...
<head>
    ...
    <style>
        ...
        * {
        ...
        .avs-stat-icon.si-purple {
            background: #ede9fe;
            color: #7c3aed;
        }

        .avs-stat-icon.si-green {
            background: #dcfce7;
            color: #16a34a;
        }

        .avs-stat-icon.si-amber {
            background: #fef3c7;
            color: #d97706;
        }

        .avs-stat-icon.si-cyan {
            background: #cffafe;
            color: #0891b2;
        }

        .avs-stat-icon.si-rose {
            background: #ffe4e6;
            color: #e11d48;
        }

        .avs-stat-icon.si-indigo {
            background: #e0e7ff;
            color: #4338ca;
        }

        .avs-stat-icon.si-teal {
            background: #ccfbf1;
            color: #0d9488;
        }

        .avs-stat-icon.si-sky {
            background: #e0f2fe;
            color: #0284c7;
        }
        ...
        <div class="page-body">
            ...
            <div class="row g-3 mb-4">
                <div class="col-6 col-xl-3">
                    <div class="stat-card">
                        <div class="avs-stat-icon si-purple"><i class="bi bi-people-fill"></i></div>
                        <div>
                            <div class="avs-stat-value"><?php echo number_format($stats['total_users']); ?></div>
                            <div class="avs-stat-label">Total Users</div>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-xl-3">
                    <div class="stat-card">
                        <div class="avs-stat-icon si-indigo"><i class="bi bi-card-list"></i></div>
                        <div>
                            <div class="avs-stat-value"><?php echo number_format($stats['total_posts']); ?></div>
                            <div class="avs-stat-label">Total Posts</div>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-xl-3">
                    <div class="stat-card">
                        <div class="avs-stat-icon si-cyan"><i class="bi bi-chat-dots-fill"></i></div>
                        <div>
                            <div class="avs-stat-value"><?php echo number_format($stats['total_comments']); ?></div>
                            <div class="avs-stat-label">Total Comments</div>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-xl-3">
                    <div class="stat-card">
                        <div class="avs-stat-icon si-green"><i class="bi bi-currency-dollar"></i></div>
                        <div>
                            <div class="avs-stat-value">?<?php echo number_format($stats['total_value'], 0); ?></div>
                            <div class="avs-stat-label">Listed Value</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-3 mb-4">
                <div class="col-6 col-xl-3">
                    <div class="stat-card">
                        <div class="avs-stat-icon si-amber"><i class="bi bi-person-badge-fill"></i></div>
                        <div>
                            <div class="avs-stat-value"><?php echo number_format($stats['total_farmers']); ?></div>
                            <div class="avs-stat-label">Farmers</div>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-xl-3">
                    <div class="stat-card">
                        <div class="avs-stat-icon si-sky"><i class="bi bi-bag-heart-fill"></i></div>
                        <div>
                            <div class="avs-stat-value"><?php echo number_format($stats['total_buyers']); ?></div>
                            <div class="avs-stat-label">Buyers</div>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-xl-3">
                    <div class="stat-card">
                        <div class="avs-stat-icon si-teal"><i class="bi bi-check-circle-fill"></i></div>
                        <div>
                            <div class="avs-stat-value"><?php echo number_format($stats['approved_posts']); ?></div>
                            <div class="avs-stat-label">Approved Posts</div>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-xl-3">
                    <div class="stat-card">
                        <div class="avs-stat-icon si-rose"><i class="bi bi-hourglass-split"></i></div>
                        <div>
                            <div class="avs-stat-value"><?php echo number_format($stats['pending_posts']); ?></div>
                            <div class="avs-stat-label">Pending Posts</div>
                        </div>
                    </div>
                </div>
            </div>
